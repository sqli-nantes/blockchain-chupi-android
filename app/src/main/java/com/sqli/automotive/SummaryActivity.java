...
<<<<<<< HEAD:app/src/main/java/com/example/joel/automotive/SummaryActivity.java
                            price.setText(nf.format(priceValue.divide(new BigInteger("1000000000000000")).intValue()/1000f) + " Ether(s)");
=======
                            price.setText(nf.format(priceValue.divide(new BigInteger("1000000000000000")).intValue()/1000f)+ " Ether(s)");
>>>>>>> feature-code-cleanned:app/src/main/java/com/sqli/automotive/SummaryActivity.java
                        }
                    });
                }
            }
