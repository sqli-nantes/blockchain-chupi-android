...
public abstract class Utils {
    ...
    */
    ...
    public static String bigDecimalToHex(String value){
    ...
    public static String toHex(Object obj) throws IllegalArgumentException{
        if( isBoolean(obj) ){
            ...
            return bigDecimalToHex(bd.toPlainString()); //TODO check function done
            ...
            if( s.contains("0x") ) return s;
                ...
                return bigDecimalToHex(s); //TODO check function done
            } else{
                return asciiToHex(s);
            }
        }
